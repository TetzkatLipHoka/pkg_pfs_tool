...
/* When set, rsa_pkcsv15_verify* stays silent on verification failure — used when
   probing many candidate keys (SELF root key selection) where misses are expected. */
int g_rsa_verify_quiet = 0;
