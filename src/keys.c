...
const uint32_t g_self_root_key_types[SELF_ROOT_KEY_TYPE_COUNT] = { 0x00, 0x01, 0x02, 0x100 };

struct self_root_keyset g_self_root_keys[SELF_ROOT_KEY_TYPE_COUNT] = {
  { 0x00, 0, {{0}}, {{0}}, { "self_root_key_0", NULL, "010001", NULL, NULL, NULL, NULL, NULL, NULL } },
  { 0x01, 0, {{0}}, {{0}}, { "self_root_key_1", NULL, "010001", NULL, NULL, NULL, NULL, NULL, NULL } },
  { 0x02, 0, {{0}}, {{0}}, { "self_root_key_2", NULL, "010001", NULL, NULL, NULL, NULL, NULL, NULL } },
  { 0x100, 0, {{0}}, {{0}}, { "self_root_key_3", NULL, "010001", NULL, NULL, NULL, NULL, NULL, NULL } },
};
